...
public class WishListCarAdapter extends RecyclerView.Adapter<WishListCarAdapter.ViewHolder> {

    private ArrayList<CarData> carList;
    private Context context;

    // data is passed into the constructor
    public WishListCarAdapter(Context context, ArrayList<CarData> carList) {
